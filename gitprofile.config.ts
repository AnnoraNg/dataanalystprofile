...
const CONFIG = {
  ...
  seo: { title: 'Data Portfolio of Annora Ng', description: 'Data Analytics Projects by Annora Ng', imageURL: 'https://raw.githubusercontent.com/AnnoraNg/dataanalystprofile/main/seo-cover2.png' },
  social: {
    linkedin: 'annorang',
    x: '',
    mastodon: '',
